...
public class CheckoutContext {
    ...
    public List<CartItem> getItemsToOrder() { return itemsToOrder; }
    public void setItemsToOrder(List<CartItem> itemsToOrder) { this.itemsToOrder = itemsToOrder; }

    public Integer getAddressId() { return addressId; }
    public void setAddressId(Integer addressId) { this.addressId = addressId; }

    public Address getChosenAddress() { return chosenAddress; }
    public void setChosenAddress(Address chosenAddress) { this.chosenAddress = chosenAddress; }

    public Address getOrderAddress() { return orderAddress; }
