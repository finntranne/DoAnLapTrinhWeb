...
public class AuthController {
        ...
        try {
            ...
            Authentication authentication = authenticationManager.authenticate(
                    new UsernamePasswordAuthenticationToken(
                        user.getUsername(), // Dùng username (hoặc email nếu logic UserDetailsService của bạn cho phép)
            ...
            String redirectUrl = determineTargetUrl(authentication); // Gọi hàm trợ giúp
            logger.info("User logged in: {}, redirecting to: {}", user.getUsername(), redirectUrl);
            ...
            return ResponseEntity.ok(Map.of(
                ...
                "redirectUrl", redirectUrl // Trả về URL động
            ));
    ...
    private String determineTargetUrl(Authentication authentication) {
        ...
        // Fallback cho các role khác (ví dụ: SHIPPER) hoặc nếu không có role khớp
